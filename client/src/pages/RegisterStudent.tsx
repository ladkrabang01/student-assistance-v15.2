        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-purple-600 to-pink-400 text-white rounded-t-lg">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <CardTitle className="text-white">สมัครสมาชิก - นักศึกษา</CardTitle>
                <p className="text-sm text-purple-100 mt-1">สร้างบัญชีใหม่เพื่อเข้าใช้ระบบ</p>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent className="pt-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 mt-6"
                disabled={isLoading}
              >
